...
class SchedualTest {
	...
	@Test
	fun test1(){
		val tired = SimpleDelayEventManager("tired", Consumer { s -> println(s) }, redisTemplate)
		...
		val full = SimpleDelayEventManager("full", Consumer { s -> System.err.println(s) }, redisTemplate)
